...
- **Data Visualization**: Mexer supports multiple visualization types, including sankey diagrams, x-y plots and matrices, allowing users to explore energy data from different perspectives.
- **Customization**: Users can customize visualizations based on specific needs, such as selecting data ranges, applying filters, and modifying visualization parameters.
...
- **Containerized Deployment**: Mexer uses a docker-based deployment ot ensure ease of installation and compatibility across different environments [@docker].
